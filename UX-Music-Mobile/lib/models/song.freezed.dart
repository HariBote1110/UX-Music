...
mixin _$Song {
 ...
 String get id; String get path; String get title; String get artist; String get album;@JsonKey(name: 'albumartist') String get albumArtist; int get year; String get genre; double get duration; int get trackNumber; int get discNumber; int get fileSize; String get fileType; int? get sampleRate; int? get bitDepth;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is Song&&(identical(other.id, id) || other.id == id)&&(identical(other.path, path) || other.path == path)&&(identical(other.title, title) || other.title == title)&&(identical(other.artist, artist) || other.artist == artist)&&(identical(other.album, album) || other.album == album)&&(identical(other.albumArtist, albumArtist) || other.albumArtist == albumArtist)&&(identical(other.year, year) || other.year == year)&&(identical(other.genre, genre) || other.genre == genre)&&(identical(other.duration, duration) || other.duration == duration)&&(identical(other.trackNumber, trackNumber) || other.trackNumber == trackNumber)&&(identical(other.discNumber, discNumber) || other.discNumber == discNumber)&&(identical(other.fileSize, fileSize) || other.fileSize == fileSize)&&(identical(other.fileType, fileType) || other.fileType == fileType)&&(identical(other.sampleRate, sampleRate) || other.sampleRate == sampleRate)&&(identical(other.bitDepth, bitDepth) || other.bitDepth == bitDepth));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,path,title,artist,album,albumArtist,year,genre,duration,trackNumber,discNumber,fileSize,fileType,sampleRate,bitDepth);

@override
String toString() {
  return 'Song(id: $id, path: $path, title: $title, artist: $artist, album: $album, albumArtist: $albumArtist, year: $year, genre: $genre, duration: $duration, trackNumber: $trackNumber, discNumber: $discNumber, fileSize: $fileSize, fileType: $fileType, sampleRate: $sampleRate, bitDepth: $bitDepth)';
}
...
@useResult
$Res call({
 String id, String path, String title, String artist, String album,@JsonKey(name: 'albumartist') String albumArtist, int year, String genre, double duration, int trackNumber, int discNumber, int fileSize, String fileType, int? sampleRate, int? bitDepth
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String path,  String title,  String artist,  String album, @JsonKey(name: 'albumartist')  String albumArtist,  int year,  String genre,  double duration,  int trackNumber,  int discNumber,  int fileSize,  String fileType,  int? sampleRate,  int? bitDepth)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Song() when $default != null:
return $default(_that.id,_that.path,_that.title,_that.artist,_that.album,_that.albumArtist,_that.year,_that.genre,_that.duration,_that.trackNumber,_that.discNumber,_that.fileSize,_that.fileType,_that.sampleRate,_that.bitDepth);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String path,  String title,  String artist,  String album, @JsonKey(name: 'albumartist')  String albumArtist,  int year,  String genre,  double duration,  int trackNumber,  int discNumber,  int fileSize,  String fileType,  int? sampleRate,  int? bitDepth)  $default,) {final _that = this;
switch (_that) {
case _Song():
return $default(_that.id,_that.path,_that.title,_that.artist,_that.album,_that.albumArtist,_that.year,_that.genre,_that.duration,_that.trackNumber,_that.discNumber,_that.fileSize,_that.fileType,_that.sampleRate,_that.bitDepth);case _:
  throw StateError('Unexpected subclass');
...
class _Song extends Song {
  const _Song({required this.id, required this.path, this.title = '', this.artist = '', this.album = '', @JsonKey(name: 'albumartist') this.albumArtist = '', this.year = 0, this.genre = '', this.duration = 0.0, this.trackNumber = 0, this.discNumber = 0, this.fileSize = 0, this.fileType = '', this.sampleRate, this.bitDepth}): super._();
