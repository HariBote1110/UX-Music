...
struct UXMusicTVApp: App {
    ...
    var body: some Scene {
        WindowGroup {
            ...
            // `UXTV_PREVIEW=nowplaying|nowplayingnolyrics|nowplayingambient|browse|albumdetail`
            // (e.g. via `SIMCTL_CHILD_UXTV_PREVIEW=nowplaying xcrun simctl launch …`) renders a screen with
            ...
            case "nowplayingnolyrics":
                TVNowPlayingPreviewHarness(lines: [])
