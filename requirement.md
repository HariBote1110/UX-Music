...
-   **[最優先] YouTube動画の再生に失敗する**:
    -   **現象**: ダウンロードしたYouTube動画を再生しようとすると、エラーが発生して再生できない。UIの更新処理で再生用の要素が見つからなくなることが原因。
-   **[最優先] YouTube動画ダウンロード後にアートワークが消失する**:
    -   **現象**: YouTube動画を1曲ダウンロードすると、ライブラリ全体のアルバムアートワークの情報が失われる。`albums.json`の更新処理に問題がある可能性が高い。
